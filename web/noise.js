/**
 * Simplex noise implementation (2D/3D) derived from Stefan Gustavson's public domain reference.
 * @module noise
 */
...
/**
 * Mulberry32 PRNG used for deterministic permutation scrambling.
 * @param {number} seed
 * @returns {() => number}
 */
